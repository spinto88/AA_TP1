...
La figura siguiente \comparb muestra el desempeño en función del número de componentes.

\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.4\textwidth}
      \includegraphics[width=\textwidth]{../imagenes/desempeño_vs_componentes_arboles.png}
    \end{subfigure}
    \caption{}
    \label{fig:comparb}
\end{figure}
