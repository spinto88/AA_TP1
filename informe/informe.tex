...
\todo[inline]{¿Cu\'ales son los resultados?. Me parece que los resultados los fuimos reportando a medida una parte en la secci\'on ``modelos'' y otra en la secci\'on ``reducci\'on de dimensionalidad''. Por eso puse los resultados finales todos juntos en esta secci\'on. No guradamos un subconjunto de datos para test. }

\section{trees + PCA}

\todo[inline]{Probar tree con 5 10 20 , 40 80 y 127 variables }
...
\todo[inline]{Probar SVM poly con 10000 datos con 5 10 20 y 40 variables}
